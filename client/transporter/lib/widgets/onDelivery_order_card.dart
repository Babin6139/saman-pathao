...
class OnDeliveryOrderCard extends StatefulWidget {
  final order, index;
  const OnDeliveryOrderCard({Key? key, this.order, this.index})
      : super(key: key);

  @override
  State<OnDeliveryOrderCard> createState() =>
      _OnDeliveryOrderCardState(order, index);
}

class _OnDeliveryOrderCardState extends State<OnDeliveryOrderCard> {
  final index;
  OnDeliveryOrders order;
  _OnDeliveryOrderCardState(this.order, this.index);
  @override
            ...
            child: ListTile(
              ...
              subtitle: ListView(
                ...
                children: [
                  ...
                  Row(
                    children: [countDownTimer(endTime: order.timeFrame.end)],
                  ),
                ],
              ),
            ),
